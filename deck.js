...
{ type:"prompts", sec:"A. 스레드·인스타", title:"⑫ 받은 토큰은 어떻게 보관하나",
  lead:"🔴 <b>토큰을 채팅창에 붙여넣지 마세요.</b> 대화 기록에 그대로 남습니다.<br>대신 <b>메모장에 붙여넣고, 그 파일을 클로드에게 넘기면</b> 나머지는 알아서 합니다. 손으로 옮겨 적을 것이 없습니다.",
  cards:[
    { tag:"① 메모장에 그냥 붙여넣기",
      body:'윈도우 검색창에 <span class="v">메모장</span> → 실행<br>받은 값을 <b>한 줄에 하나씩</b> 붙여넣습니다.<br><br>어느 줄이 무슨 토큰인지 <b>적지 않아도 됩니다.</b><br>순서도 상관없습니다.<br><br>👉 <span class="v">C:\\sns-auto\\토큰.txt</span> 로 저장' },
    { tag:"② 클로드에게 이 한 줄",
      body:'클로드 데스크탑 대화창에 그대로 붙여넣습니다<br><br><span class="v">C:\\sns-auto\\토큰.txt 에 토큰 적어뒀어.<br>읽어서 저장해줘</span><br><br>클로드가 알아서 아래 명령을 실행합니다' },
    { tag:"③ 클로드가 실행하는 것",
      body:'<span class="v">cd C:\\sns-auto\\tistory</span><br><span class="v">python src\\save_tokens.py "C:\\sns-auto\\토큰.txt"</span><br><br>서버에 직접 물어 <b>스레드·인스타·제미나이를 스스로 구분</b>해 제자리에 넣습니다' },
    { tag:"④ 이렇게 나오면 끝",
      body:'<span class="v">=== 저장 결과 ===</span><br><span class="v">스레드   저장됨   @내계정</span><br><span class="v">인스타   저장됨   @내계정</span><br><span class="v">제미나이 키 저장됨</span><br><br>계정 이름까지 확인해주므로 <b>엉뚱한 계정에 저장될 일이 없습니다</b>' },
    { tag:"⑤ 마지막 — 메모 파일은 지웁니다",
      body:'저장이 끝나면 <b>메모 파일을 지울지 물어봅니다.</b> 그냥 엔터를 치면 지워집니다.<br><br>토큰은 <b>비밀번호와 같습니다.</b><br>저장된 곳(<span class="v">.auth</span> 폴더)은 이 폴더 밖으로 나가지 않습니다' },
    { tag:"⑥ 붙여넣기가 안 될 때",
      body:'메모장에서는 <span class="v">Ctrl+V</span> 가 정상 동작합니다.<br><br>혹시 검은 명령창에 직접 붙여넣을 일이 생기면,<br><b>마우스 오른쪽 클릭</b>으로 붙여넣으세요.<br>거기서는 <span class="v">Ctrl+V</span> 가 글자 하나로 들어갑니다' } ] },
...
{ type:"prompts", sec:"B. 유튜브 인증", title:"⑮ 받은 JSON 파일은 어디에 두나",
  lead:"내려받은 <span class=\"v\">client_secret_…json</span> 은 <b>손댈 것이 없습니다.</b> 열지도, 이름을 바꾸지도, 내용을 복사하지도 않습니다.<br>엔진이 <b>여러 폴더를 알아서 뒤져</b> 찾으므로, 아래 중 아무 곳에나 두면 됩니다.",
  cards:[
    { tag:"① 파일 위치 확인",
    ...
    { tag:"② 둬도 되는 곳 — 아무 데나 하나",
      body:'· <span class="v">C:\\Users\\사용자명\\</span> (사용자 폴더)<br>· <span class="v">C:\\sns-auto\\</span> (과정 작업 폴더)<br>· <span class="v">Downloads</span> 폴더 — <b>그냥 둬도 됩니다</b><br><br>엔진이 이 폴더들을 차례로 뒤져 찾습니다' },
    { tag:"③ 파일을 열거나 고칠 필요 없습니다 ★",
      body:'· 메모장으로 열어볼 필요 <b>없음</b><br>· 안의 내용을 복사할 필요 <b>없음</b><br>· <b>이름을 바꾸면 안 됩니다</b> — <span class="v">client_secret_</span> 로 시작하는 이름으로 찾습니다<br><br>🔴 이 파일 안에는 비밀번호와 같은 값이 들어 있습니다. 채팅창에 붙여넣지 마세요' },
    { tag:"④ 클로드에게 시키면 더 쉽습니다",
      body:'직접 옮기기 번거로우면 이렇게 말하면 됩니다<br><br><span class="v">다운로드 폴더에 client_secret 파일<br>받았어. 제자리에 옮겨줘</span><br><br>파일을 <b>열지 않고 옮기기만</b> 합니다' },
    { tag:"⑤ 첫 실행 — 인증 창이 열립니다",
      body:'쇼츠를 처음 만들 때 브라우저가 자동으로 열립니다<br>→ 계정 선택 → 권한 허용<br><br>실행 화면에 <span class="v">client_secret 발견: (폴더)</span> 가<br>찍히면 제대로 찾은 것입니다' } ] },
