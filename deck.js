...
{ type:"concept", eyebrow:"보안", title:"이 JSON 파일, Claude 에 첨부해도 되나요?",
  ...
  bullets:[
    {h:"왜 안 되나", t:"파일 안에 <b>클라이언트 시크릿</b>(비밀번호에 해당)이 들어 있습니다. 첨부하면 그 값이 대화 기록에 그대로 남습니다"},
    {h:"토큰과 같은 원칙입니다", t:"스레드·인스타 토큰을 채팅창에 붙여넣지 않는 것과 똑같은 이유입니다"},
    {h:"첨부할 필요가 없는 이유", t:"Claude 는 파일의 <b>내용</b>이 아니라 <b>위치</b>만 알면 됩니다. 제자리에 있으면 엔진이 읽어서 인증합니다"},
    {h:"그럼 뭘 하면 되나", t:"다운로드 폴더에서 <b>C:\\Users\\사용자명\\</b> 으로 <b>옮기기만</b> 하면 끝입니다"} ],
...
{ type:"concept", eyebrow:"보안 — 꼭 지켜주세요", title:"채팅창에 넣지 말아야 할 것 3가지",
  ...
  bullets:[
    {h:"① 토큰 (인스타 · 스레드)", t:"긴 문자열 열쇠입니다. <b>PowerShell 로 .env 파일에</b> 직접 씁니다"},
    {h:"② client_secret JSON 파일", t:"첨부도 안 됩니다. <b>파일을 옮기기만</b> 하면 Claude 가 알아서 찾습니다"},
    {h:"③ 비밀번호 · API 키", t:"로그인 창이 뜨면 <b>본인이 직접</b> 입력합니다. AI 는 대신 입력하지 않습니다"} ],
